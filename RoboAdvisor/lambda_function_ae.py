...
def recommend_portfolio(intent_request):
    ...
    if source == "DialogCodeHook":
            ...
            if age is not None:
                ...
                if 0 > age < 65 :
                    return build_validation_result(
                        False,
                        "age",
                        "The maximum age is 64. Please provide an age between 0 and 64.",
                    )
            ...
            if investment_amount is not None:
                ...
                if investment_amount < 5000: 
                    return build_validation_result(
                        False,
                        "investmentAmount",
                        "The minimum amount should be equal to or greater than 5000, "
        ...
        # Validation - user's input with validate_data function
